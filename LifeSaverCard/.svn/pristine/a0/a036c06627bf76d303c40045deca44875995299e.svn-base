...
public class MedicalCheckAdapter extends BaseAdapter {
    private Context context;
    private String[] data;
    private List<String> remarkList = new ArrayList<>();//存放选中数据

    public MedicalCheckAdapter(Context context) {
    ...
    private void getRemark() {
        ...
        remarkClickListener.onClick(MedicalCheckAdapter.this, strRemark, remarkList);
    }
    ...
    public interface RemarkClickListener {
        void onClick(MedicalCheckAdapter context, String remarkStr, List<String> datas);
    }
