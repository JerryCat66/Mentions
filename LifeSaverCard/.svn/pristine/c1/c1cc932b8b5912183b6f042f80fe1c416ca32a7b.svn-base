...
public class PermissionActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if (isRequireCheck) {
            ...
            if (mChecker.isLackPermissions(permissions)) {
    ...
    private void showMissingPermissionDialog() {
        TipsDialog.makeDialog(this, "提示", getResources().getString(R.string.string_help_text), "设置", "退出", new TipsDialog.onDialogListener() {
            @Override
