...
public class CircularImageView extends ImageView
{
	...
	private void init(Context context, AttributeSet attrs, int defStyle)
	{
		...
		if(hasBorder) {
			...
			setBorderWidth(attributes.getDimensionPixelOffset(R.styleable.CircularImageView_border_width1, defaultBorderSize));
			setBorderColor(attributes.getColor(R.styleable.CircularImageView_border_color1, Color.WHITE));
		}
