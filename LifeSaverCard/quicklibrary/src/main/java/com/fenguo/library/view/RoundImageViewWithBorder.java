...
public class RoundImageViewWithBorder extends ImageView {
    /**
     * 边框颜色
     */
    ...
    public RoundImageViewWithBorder(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(context, attrs);
    }

    public RoundImageViewWithBorder(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttrs(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public RoundImageViewWithBorder(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        try {
            ...
            mBorderColor = ta.getColor(R.styleable.round_imageView_border_color2, 0x00000000);
            mBorderWidth = (int) ta.getDimension(R.styleable.round_imageView_border_width2, 0);
